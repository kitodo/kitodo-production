...
//   private String Verlag="";
   ...
   /**
    * Erzeugen des Tiff-Headers anhand des übergebenen Prozesses
    * Einlesen der Eigenschaften des Werkstücks bzw. der Scanvorlage
    */
   public TiffHeader(Prozess inProzess) {
      if (inProzess.getWerkstueckeSize() > 0) {
         ...
         if (myWerkstueck.getEigenschaftenSize() > 0) {
            for (Iterator iter = myWerkstueck.getEigenschaften().iterator(); iter.hasNext();) {
...
//      return strBuf.toString();
   ...
   /**
    * S�mtliche Tiff-Header-Daten als ein grosser String
   ...
   public String getTiffAlles() {
      ...
      strBuf.append("# Konfigurationsdatei fuer TIFFWRITER.pl" + lineBreak);
      strBuf.append("#" + lineBreak);
      strBuf.append("# - muss in dem Verzeichnis liegen, in dem sich auch die TIFF-Images befinden"
            + lineBreak);
      strBuf.append("# - gibt an, welche TIFF-Tags überschrieben werden sollen." + lineBreak);
      strBuf.append("#" + lineBreak);
