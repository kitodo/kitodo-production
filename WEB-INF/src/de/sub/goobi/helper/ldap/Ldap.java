...
public class Ldap {
    ...
    * @throws IOException 
    */
   public void createNewUser(Benutzer inBenutzer, String inPasswort) throws NamingException,
    ...
    * @throws NoSuchAlgorithmException
    */
   public boolean changeUserPassword(Benutzer inBenutzer, String inOldPassword, String inNewPassword)
         throws NoSuchAlgorithmException {
      Hashtable<String, String> env = LdapConnectionSettings();
      env.put(Context.SECURITY_PRINCIPAL, getUserDN(inBenutzer));
      ...
      try {
         ...
         //         System.out.println("Ausgelesenes Password1: " + new String((passwdhash)));
