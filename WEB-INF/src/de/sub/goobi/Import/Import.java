...
//         Einlesen(prozessID.toString());
         ...
         importFehler = "Es ist ein Fehler aufgetreten: " + e.getMessage();
         e.printStackTrace();
      }
   ...
   private void Einlesen() throws IOException, WrongImportFileException,
      ...
      try {
         ...
         /* --------------------------------
          * prüfen ob es ein russischer oder ein zbl-Import ist
          * und entsprechende Routine aufrufen
          * --------------------------------*/
