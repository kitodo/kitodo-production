...
public class RDF {
     ...
     * The RDF subject.
     */
    public static final NodeReference ABOUT = new NodeReference("http://www.w3.org/1999/02/22-rdf-syntax-ns#about");

    /**
     * The datatype of language-tagged string values
     */
    public static final NodeReference LANG_STRING = new NodeReference(
     ...
     */
    public static final NodeReference NIL = new NodeReference("http://www.w3.org/1999/02/22-rdf-syntax-ns#nil");

    /**
     * The object of the subject RDF statement.
     */
    public static final NodeReference OBJECT = new NodeReference("http://www.w3.org/1999/02/22-rdf-syntax-ns#object");

    /**
     * The class of plain (i.e. untyped) literal values, as used in RIF and OWL
     * 2
     */
    public static final NodeReference PLAIN_LITERAL = new NodeReference(
            "http://www.w3.org/1999/02/22-rdf-syntax-ns#PlainLiteral");

    /**
     * The predicate of the subject RDF statement.
     */
    public static final NodeReference PREDICATE = new NodeReference(
     ...
     */
    public static final NodeReference TYPE = new NodeReference("http://www.w3.org/1999/02/22-rdf-syntax-ns#type");

    /**
     * Idiomatic property used for structured values.
     */
    public static final NodeReference VALUE = new NodeReference("http://www.w3.org/1999/02/22-rdf-syntax-ns#value");

    /**
     * The datatype of XML literal values.
     */
    public static final NodeReference XML_LITERAL = new NodeReference(
