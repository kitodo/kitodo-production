...
public class AuthorityFileUtil {
	...
	public static Node downloadAuthorityRecord(String recordURI)
		...
		String parameter = Parameters.AUTHORITY_DATA_URL_TAIL.replaceFirst("\\{0\\}", prefix != null ? prefix : namespace);
	...
	public static String getRecordURI(MetadataGroup metaDataGroup) {
		...
		Set<String> valueMetaDataSet = new HashSet<String>(Arrays.asList(valueMetaData));
