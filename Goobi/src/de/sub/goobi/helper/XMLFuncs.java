...
public class XMLFuncs {
	...
	/**
	 * The method documentToString() converts an org.w3c.dom.Document to a
	 * String
	 * 
	 * @param data
	 ...
	 *             transformation
	 */
	public static String documentToString(Document data, Integer indent) throws TransformerFactoryConfigurationError,
