...
public class RDFTest {
    ...
    public void testSequenceNumberOfMin() {
        assertEquals(
            Node.FIRST_INDEX,
            RDF.sequenceNumberOf("http://www.w3.org/1999/02/22-rdf-syntax-ns#_1")
        );
    }
    ...
    public void testSequenceNumberOfOneAboveMin() {
        assertEquals(
            Node.FIRST_INDEX + 1,
            RDF.sequenceNumberOf("http://www.w3.org/1999/02/22-rdf-syntax-ns#_2")
        );
    }
    ...
    public void testSequenceNumberOfInTheMiddle() {
        assertEquals(
            4_500_000_000_000_000_000L,
            RDF.sequenceNumberOf("http://www.w3.org/1999/02/22-rdf-syntax-ns#_4500000000000000000")
        );
    }
    ...
    public void testSequenceNumberOfOneBelowMax() {
        assertEquals(
            Long.MAX_VALUE - 1,
            RDF.sequenceNumberOf("http://www.w3.org/1999/02/22-rdf-syntax-ns#_9223372036854775806")
        );
    }
    ...
    public void testSequenceNumberOfMax() {
        assertEquals(
            Long.MAX_VALUE,
            RDF.sequenceNumberOf("http://www.w3.org/1999/02/22-rdf-syntax-ns#_9223372036854775807")
        );
    }
    ...
    public void testToURLInTheMiddle() {
        assertEquals(
            "http://www.w3.org/1999/02/22-rdf-syntax-ns#_4500000000000000000",
