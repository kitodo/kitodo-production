								...
								<htm:table cellpadding="3" cellspacing="0" width="100%"
									...
									<htm:tr>
										<htm:td styleClass="eingabeBoxen_row1">
											<h:outputText id="id6" value="#{msgs.neuesPasswortFestlegen}" />
										</htm:td>
									</htm:tr>
									<htm:tr>
										<htm:td styleClass="eingabeBoxen_row2">
											...
											<h:panelGrid id="grid1" columns="2">
												...
												<h:panelGroup id="id12">
													...
													<x:message id="id13" for="passwortAendernNeu1" style="color: red"
												...
												<h:panelGroup id="id15">
													...
													<x:message id="id16" for="passwortAendernNeu2" style="color: red"
														replaceIdWithLabel="true" />
												</h:panelGroup>
