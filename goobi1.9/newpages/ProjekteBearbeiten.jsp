		...
		<htm:tr>
			...
			<htm:td valign="top" styleClass="layoutInhalt">
				...
				<h:form id="projectform">
					<%-- Breadcrumb --%>
					<h:panelGrid width="100%" columns="1" styleClass="layoutInhaltKopf" id="projectgrid1">
						<h:panelGroup id="id1">
							<h:commandLink id="id2" value="#{msgs.startseite}" action="newMain" />
							<f:verbatim> &#8250;&#8250; </f:verbatim>
							<h:commandLink id="id3" value="#{msgs.projekte}" action="ProjekteAlle" />
							<f:verbatim> &#8250;&#8250; </f:verbatim>
							<h:outputText id="id4" value="#{msgs.neuesProjektAnlegen}" rendered="#{ProjekteForm.myProjekt.id == null}" />
							<h:outputText id="id5" value="#{msgs.projektBearbeiten}" rendered="#{ProjekteForm.myProjekt.id != null}" />
						</h:panelGroup>
					</h:panelGrid>
					...
					<htm:table border="0" align="center" width="100%" cellpadding="15">
						<htm:tr>
							<htm:td>
								<htm:h3>
									<h:outputText id="id6" value="#{msgs.neuesProjektAnlegen}" rendered="#{ProjekteForm.myProjekt.id == null}" />
									<h:outputText id="id7" value="#{msgs.projektBearbeiten}" rendered="#{ProjekteForm.myProjekt.id != null}" />
								</htm:h3>
										...
										<htm:td styleClass="eingabeBoxen_row2" colspan="2">
											...
											<x:panelTabbedPane serverSideTabSwitch="true" immediateTabChange="false" styleClass="tabbedPane" activeTabStyleClass="activeTab"
												...
												<x:panelTab label="#{msgs.details}">
													...
													<htm:div id="tab1">
														<h:panelGrid columns="2" rowClasses="top" id="projgrid2" styleClass="tableDetails ">
															...
															<%-- Titel --%>
															<h:outputLabel id="id17" for="titel" value="#{msgs.titel}" />
															<h:panelGroup id="id18">
																<h:inputText id="titel" style="width: 200px;margin-right:15px" value="#{ProjekteForm.myProjekt.titel}" required="true" />
																<x:message id="id19" for="titel" style="color: red" replaceIdWithLabel="true" />
															</h:panelGroup>
												...
												<h:selectBooleanCheckbox id="id23" style="margin-right:15px"
													...
													<h:outputText id="vwid36a" value="#{msgs.projectIsArchived}" />
                                               		 <h:selectBooleanCheckbox id="vwid37b" style="margin-right:15px"
												...
												<x:panelTab label="#{msgs.technischeDaten}">
													...
													<htm:div id="tab2">
														<h:panelGrid columns="2" rowClasses="top" id="projgrid3">
															...
															<h:outputText id="id34" value="#{msgs.internesSpeicherformat}" />
															<h:selectOneMenu id="id35" style="width: 300px;margin-right:15px" value="#{ProjekteForm.myProjekt.fileFormatInternal}">
																<si:selectItems value="#{HelperForm.fileFormatsInternalOnly}" var="format" itemLabel="#{format}" itemValue="#{format}" />
															</h:selectOneMenu>

															<%-- Speicherformate für das DMS (mehrere möglich) --%>
															<h:outputText id="id36" value="#{msgs.dmsExportformat}" />
															<h:selectOneMenu id="id37" style="width: 300px;margin-right:15px" value="#{ProjekteForm.myProjekt.fileFormatDmsExport}">
																<si:selectItems id="id38" value="#{HelperForm.fileFormats}" var="format" itemLabel="#{format}" itemValue="#{format}" />
															</h:selectOneMenu>

															<%-- nutzt DMS-Import --%>
															<h:outputText id="id39" value="#{msgs.automatischerDmsImport}" />
															<h:selectBooleanCheckbox id="id40" style="margin-right:15px" value="#{ProjekteForm.myProjekt.useDmsImport}" />

															<%-- Dms-Import-XML-DATEI-Pfad --%>
															<h:outputText id="id41" value="#{msgs.dmsImportPfadXmlDatei}" />
															<h:inputText id="id42" style="width: 300px;margin-right:15px" value="#{ProjekteForm.myProjekt.dmsImportRootPath}" />

															<%-- Dms-Import-Images-Pfad --%>
															<h:outputText id="id43" value="#{msgs.dmsImportImagesPfad}" />
															<h:inputText id="id44" style="width: 300px;margin-right:15px" value="#{ProjekteForm.myProjekt.dmsImportImagesPath}" />

															<%-- Dms-Import-Success-Pfad --%>
															<h:outputText id="id45" value="#{msgs.dmsImportSuccessPfad}" />
															<h:inputText id="id46" style="width: 300px;margin-right:15px" value="#{ProjekteForm.myProjekt.dmsImportSuccessPath}" />

															<%-- Dms-Import-Error-Pfad --%>
															<h:outputText id="id47" value="#{msgs.dmsImportErrorPfad}" />
															<h:inputText id="id48" style="width: 300px;margin-right:15px" value="#{ProjekteForm.myProjekt.dmsImportErrorPath}" />

															<%-- nutzt DMS-Import --%>
															<h:outputText value="#{msgs.dmsImportCreateProcessFolder}" />
															<h:selectBooleanCheckbox id="id49" style="margin-right:15px" value="#{ProjekteForm.myProjekt.dmsImportCreateProcessFolder}" />

															<%-- Timeout --%>
															<h:outputLabel id="id50" for="timeout" value="#{msgs.timeout} (ms)" />
															<h:panelGroup id="id51">
																<h:inputText id="timeout" style="width: 300px;margin-right:15px" value="#{ProjekteForm.myProjekt.dmsImportTimeOut}" required="true" />
																<x:message id="id52" for="timeout" style="color: red" replaceIdWithLabel="true" />
															</h:panelGroup>
														</h:panelGrid>
													</htm:div>
												</x:panelTab>
												...
												<x:panelTab label="#{msgs.metsParamater}">
													...
													<htm:div id="tab3">
														<h:panelGrid columns="2" rowClasses="top" id="projgrid4">
															...
															<h:inputText id="id58" style="width: 650px;margin-right:15px" value="#{ProjekteForm.myProjekt.metsRightsOwner}" />

															<%-- metsRightsOwnerLogo --%>
															<h:outputText id="id59" value="#{msgs.metsRightsOwnerLogo}" />
															<h:inputText id="id60" style="width: 650px;margin-right:15px" value="#{ProjekteForm.myProjekt.metsRightsOwnerLogo}" />

															<%-- metsRightsOwnerSite --%>
															<h:outputText id="id61" value="#{msgs.metsRightsOwnerSite}" />
															<h:inputText id="id62" style="width: 650px;margin-right:15px" value="#{ProjekteForm.myProjekt.metsRightsOwnerSite}" />

															<%-- metsRightsOwnerMail --%>
															<h:outputText id="id63" value="#{msgs.metsRightsOwnerMail}" />
															<h:inputText id="id64" style="width: 650px;margin-right:15px" value="#{ProjekteForm.myProjekt.metsRightsOwnerMail}" />

															<%-- metsDigiprovReference --%>
															<h:outputText id="id65" value="#{msgs.metsDigiprovReference}" />
															<h:inputText id="id66" style="width: 650px;margin-right:15px" value="#{ProjekteForm.myProjekt.metsDigiprovReference}" />

															<%-- metsDigiprovPresentation --%>
															<h:outputText id="id67" value="#{msgs.metsDigiprovPresentation}" />
															<h:inputText id="id68" style="width: 650px;margin-right:15px" value="#{ProjekteForm.myProjekt.metsDigiprovPresentation}" />

															<%-- metsDigiprovReferenceAnchor --%>
															<h:outputText value="#{msgs.metsDigiprovReferenceAnchor}" />
															<h:inputText id="id69" style="width: 650px;margin-right:15px" value="#{ProjekteForm.myProjekt.metsDigiprovReferenceAnchor}" />

															<%-- metsDigiprovPresentationAnchor--%>
															<h:outputText value="#{msgs.metsDigiprovPresentationAnchor}" />
															<h:inputText id="id70" style="width: 650px;margin-right:15px" value="#{ProjekteForm.myProjekt.metsDigiprovPresentationAnchor}" />

															<%-- metsPointerPath --%>
															<h:outputText id="id71" value="#{msgs.metsPointerPath}" />
															<h:inputText id="id72" style="width: 650px;margin-right:15px" value="#{ProjekteForm.myProjekt.metsPointerPath}" />

															<%-- metsPointerPathAnchor --%>
															<h:outputText id="id73" value="#{msgs.metsPointerPathAnchor}" />
															<h:inputText id="id74" style="width: 650px;margin-right:15px" value="#{ProjekteForm.myProjekt.metsPointerPathAnchor}" />

															<%-- metsPurl --%>

															<h:outputText id="id75" value="#{msgs.metsPurl}" />
															<h:inputText id="id76" style="width: 650px;margin-right:15px" value="#{ProjekteForm.myProjekt.metsPurl}" />

															<%-- metsContentIDs --%>
															<h:outputText id="id77" value="#{msgs.metsContentIDs}" />
															<h:inputText id="id78" style="width: 650px;margin-right:15px" value="#{ProjekteForm.myProjekt.metsContentIDs}" />

															<%-- FileGroups --%>
															<h:outputText id="id79" value="#{msgs.metsfilegroups}" />
															<h:panelGroup id="id80">
																<x:dataTable id="id81" width="300" columnClasses="standardTable_Column,standardTable_Column,standardTable_ColumnCentered" var="item"
																	...
																	<h:column id="id84">
																		...
																		<h:panelGroup id="id85">
																			<jp:popupFrame scrolling="auto" height="200px" width="700px" topStyle="background: #1874CD;" bottomStyleClass="popup_unten"
																				styleFrame="border-style: solid;border-color: #1874CD; border-width: 2px;" styleClass="standardlink"
																				style="margin-top:2px;text-decoration:none" actionOpen="#{ProjekteForm.filegroupEdit}" actionClose="#{NavigationForm.Reload}"
																				center="true" title="#{msgs.filegroupBearbeiten}" immediate="true">
																				<x:updateActionListener property="#{ProjekteForm.zurueck}" value="FilegroupPopup" />
																				<x:updateActionListener property="#{ProjekteForm.myFilegroup}" value="#{item}" />
																				<x:updateActionListener property="#{ProjekteForm.myFilegroup}" value="#{item}" />
																				<h:graphicImage id="id86" value="images/buttons/edit_20.gif" />
																			</jp:popupFrame>
																		</h:panelGroup>

																		<%-- Löschen-Schaltknopf --%>
																		<h:commandLink action="#{ProjekteForm.filegroupDelete}" title="#{msgs.filegroupLoeschen}"
																...
																<h:panelGroup id="id87">
																	<jp:popupFrame scrolling="auto" height="200px" width="700px" topStyle="background: #1874CD;" bottomStyleClass="popup_unten"
																		styleFrame="border-style: solid;border-color: #1874CD; border-width: 2px;" styleClass="standardlink"
																		style="margin-top:2px;display:block; text-decoration:none" actionOpen="#{ProjekteForm.filegroupAdd}"
																		actionClose="#{NavigationForm.Reload}" center="true" title="#{msgs.filegroupHinzufuegen}" immediate="true">
																		<x:updateActionListener property="#{ProjekteForm.zurueck}" value="FilegroupPopup" />
																		<h:outputText style="border-bottom: #a24033 dashed 1px;" value="#{msgs.filegroupHinzufuegen}" />
																	</jp:popupFrame>
																</h:panelGroup>
															</h:panelGroup>
														</h:panelGrid>
												...
												<x:panelTab label="#{msgs.statistik}" rendered="#{ProjekteForm.myProjekt.id != null && !HelperForm.anonymized}">
													<%--
														<htm:li
													...
													<htm:div id="tab4">
														...
														<h:panelGroup id="qvzid2">
															...
															<f:facet name="header">
																<h:outputText id="qvzid3" value="#{msgs.vorgaben}" style="font-weight:normal" />
															</f:facet>

															<h:panelGrid id="projgrid6" columns="3" rowClasses="top" styleClass="tableStatistik">

																<h:panelGrid id="qqvzid4" columns="2" rowClasses="top" styleClass="leftTableStatistik">

																	<h:outputText id="qvwid8" value="#{msgs.numberImages}:" />
																	<h:outputText id="id92" style="width: 200px;margin-right:15px" value="#{ProjekteForm.myProjekt.numberOfPages}">

																	</h:outputText>

																	<%-- number of volumes --%>
																	<h:outputText id="qvwid11" value="#{msgs.numberVolumes}:" />
																	<h:outputText id="id93" style="width: 200px;margin-right:15px" value="#{ProjekteForm.myProjekt.numberOfVolumes}">
																	</h:outputText>

																	<%-- startdate --%>
																	<h:outputText id="qvwid14" value="#{msgs.startdate}:" />
																	<h:outputText id="id94" style="width: 200px;margin-right:15px" value="#{ProjekteForm.myProjekt.startDate}" />

																	<%-- enddate --%>
																	<h:outputText id="qvwid17" value="#{msgs.enddate}:" />
																	<h:outputText id="id95" style="width: 200px;margin-right:15px" value="#{ProjekteForm.myProjekt.endDate}" />

																	<%-- pages per volume --%>
																	<h:outputText id="qvqwid22" value="#{msgs.imagesPerVolume}:" />
																	<h:outputText id="qvwid23" value="#{ProjekteForm.calcImagesPerVolume}" />

																	<%-- duration --%>
																	<h:outputText id="qvwid24" value="#{msgs.durationInMonth}:" />
																	<h:outputText id="qvwid25" value="#{ProjekteForm.calcDuration}" />
																</h:panelGrid>
																<h:panelGrid id="qwevzid4" columns="2" rowClasses="top">
																	...
																	<%-- throughputPerYear --%>
																	<h:outputText id="qvwid26" value="#{msgs.volumesPerYear}:" rendered="#{ProjekteForm.calcDuration > 11}" />
																	<h:outputText id="qvwid27" value="#{ProjekteForm.calcThroughputPerYear}" rendered="#{ProjekteForm.calcDuration > 11}" />

																	<%-- throughputPerQuarter --%>
																	<h:outputText id="vqwid28" value="#{msgs.volumesPerQuarter}:" rendered="#{ProjekteForm.calcDuration > 2}" />
																	<h:outputText id="qvwid29" value="#{ProjekteForm.calcThroughputPerQuarter}" rendered="#{ProjekteForm.calcDuration > 2}" />

																	<%-- throughputPerMonth --%>
																	<h:outputText id="qvwid30" value="#{msgs.volumesPerMonth}:" rendered="#{ProjekteForm.calcDuration > 0}" />
																	<h:outputText id="qvwid31" value="#{ProjekteForm.calcThroughputPerMonth}" rendered="#{ProjekteForm.calcDuration > 0}" />

																	<%-- throughputPerDay --%>
																	<h:outputText id="qvwid32" value="#{msgs.volumesPerDay}:" />
																	<h:outputText id="qvwid33" value="#{ProjekteForm.calcThroughputPerDay}" />
																</h:panelGrid>
																<h:panelGrid id="qwevzidscfhbf4" columns="2" rowClasses="top">
																	<%-- throughputPerYear --%>
																	<h:outputText id="qqvwid26" value="#{msgs.pagesPerYear}:" rendered="#{ProjekteForm.calcDuration > 11}" />
																	<h:outputText id="qqvwid27" value="#{ProjekteForm.calcThroughputPagesPerYear}" rendered="#{ProjekteForm.calcDuration > 11}" />

																	<%-- throughputPerQuarter --%>
																	<h:outputText id="qvqwid28" value="#{msgs.pagesPerQuarter}:" rendered="#{ProjekteForm.calcDuration > 2}" />
																	<h:outputText id="qqvwid29" value="#{ProjekteForm.calcTroughputPagesPerQuarter}" rendered="#{ProjekteForm.calcDuration > 2}" />

																	<%-- throughputPerMonth --%>
																	<h:outputText id="qqvwid30" value="#{msgs.pagesPerMonth}:" rendered="#{ProjekteForm.calcDuration > 0}" />
																	<h:outputText id="qqvwid31" value="#{ProjekteForm.calcThroughputPagesPerMonth}" rendered="#{ProjekteForm.calcDuration > 0}" />

																	<%-- throughputPerDay --%>
																	<h:outputText id="qqvwid32" value="#{msgs.pagesPerDay}:" />
																	<h:outputText id="qqvwid33" value="#{ProjekteForm.calcPagesPerDay}" />
																</h:panelGrid>
															</h:panelGrid>
														</h:panelGroup>

														<%--<htm:div id="staticticdemo" styleClass="yui-navset">--%>
														<x:panelTabbedPane serverSideTabSwitch="true" immediateTabChange="false" styleClass="subTabbedPane" activeTabStyleClass="activeTab"
															inactiveTabStyleClass="inactiveTab" disabledTabStyleClass="disabledTab" activeSubStyleClass="activeSub"
															inactiveSubStyleClass="inactiveSub" tabContentStyleClass="tabContent">
															...
															--%>
																<htm:div id="stab1" styleClass="subTab1">
																	...
																	<htm:p style="width: 50px;">
																		<h:outputText id="vzid34" value="#{msgs.volumes}" style="font-weight:normal;" />
																	</htm:p>

																	<h:graphicImage id="vzid36" alt="volumes" title="#{ProjekteForm.myProjekt.titel}"
																		value="#{HelperForm.servletPathWithHostAsUrl}/pages/imagesTemp/#{ProjekteForm.projectStatVolumes}" />

																	<htm:p style="width: 50px;">
																		<h:outputText id="vzid39" value="#{msgs.seiten}" style="font-weight:normal" />
																	</htm:p>

																	<h:graphicImage id="vzid41" alt="images" title="#{ProjekteForm.myProjekt.titel}"
															...
															<x:panelTab label="#{msgs.projectProgress}">
																...
																<htm:div id="stab2" styleClass="subTab2">
																	<h:outputText id="vzid34_1" value="#{msgs.projectProgress}" style="font-weight:normal" />

																	<h:panelGrid id="pcid3" columns="4" columnClasses="standardTable_ColumnLeft,standardTable_Column,standardTable_ColumnRight"
																		rowClasses="rowTop">
																		<%-- SelectManyMenu Workflow --%>

																		<h:selectManyListbox id="vinput5" value="#{ProjekteForm.projectProgressInterface.selectedSteps}">
																			<si:selectItems value="#{ProjekteForm.projectProgressInterface.selectableSteps}" var="item" itemLabel="#{item}" itemValue="#{item}" />
																		</h:selectManyListbox>

																		<h:selectOneMenu id="pcid10" style="height:20px" value="#{ProjekteForm.projectProgressInterface.timeUnit}"
																			converter="StatisticsTimeUnitConverter">
																			<si:selectItems id="pcid11" value="#{ProjekteForm.projectProgressInterface.selectableTimeUnits}" var="unit"
																				itemLabel="#{unit.title}" itemValue="#{unit}" />
																		</h:selectOneMenu>

																		<h:panelGroup id="pcid12" style="height:20px">
																			<h:selectBooleanCheckbox id="pcid13" value="#{ProjekteForm.projectProgressInterface.referenceCurve}" title="#{msgs.refCurve}">
				...
				<x:updateActionListener value="#{ProjekteForm.projectProgressInterface}" property="#{ProjekteForm.myCurrentTable}" />
																...
																<htm:div id="stab3" styleClass="subTab3">
																	<x:aliasBeansScope>
																		...
																		<f:subview id="vzid420101">
																			<jsp:include page="/newpages/inc_statistic/StatisticProduction.jsp" />
																		</f:subview>
																	</x:aliasBeansScope>
																</htm:div>
															</x:panelTab>
																...
																<htm:div id="stab4" styleClass="subTab4">
																	<x:aliasBeansScope>
																		...
																		<f:subview id="vzid430101">
																			<jsp:include page="/newpages/inc_statistic/StatisticThroughput.jsp" />
																		</f:subview>
																	</x:aliasBeansScope>
																</htm:div>
															</x:panelTab>
																...
																<htm:div id="stab5" styleClass="subTab5">
																	<x:aliasBeansScope>
																		...
																		<f:subview id="vzid440101">
																			<jsp:include page="/newpages/inc_statistic/StatisticCorrection.jsp" />
																		</f:subview>
																	</x:aliasBeansScope>
																</htm:div>
															</x:panelTab>
																...
																<htm:div id="stab6" styleClass="subTab6">
																	<x:aliasBeansScope>
																		...
																		<f:subview id="vzid450101">
																			<jsp:include page="/newpages/inc_statistic/StatisticStorage.jsp" />
																		</f:subview>
																	</x:aliasBeansScope>
																</htm:div>
															</x:panelTab>
									...
									<htm:tr>
										<htm:td styleClass="eingabeBoxen_row3" align="left">
											<h:commandButton id="id121" value="#{msgs.abbrechen}" action="ProjekteAlle" immediate="true" />
										</htm:td>
										<htm:td styleClass="eingabeBoxen_row3" align="right">
											<h:commandButton id="id122" value="#{msgs.loeschen}" action="#{ProjekteForm.Loeschen}"
												onclick="return confirm('#{msgs.sollDieserEintragWirklichGeloeschtWerden}?')"
												rendered="#{ProjekteForm.myProjekt.id != null && ProjekteForm.myProjekt.deleteAble}" />
											<h:commandButton id="id123" value="#{msgs.uebernehmen}" action="#{ProjekteForm.Apply}" />

											<h:commandButton id="id124" value="#{msgs.speichern}" action="#{ProjekteForm.Speichern}" />
