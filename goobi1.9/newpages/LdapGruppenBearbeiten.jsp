									...
									<htm:tr>
										<htm:td styleClass="eingabeBoxen_row2" colspan="2">
											...
											<h:panelGrid id="id10" columns="2">
												...
												<h:outputLabel id="id14" for="userDN" value="#{msgs.userDN}" />
												...
												<h:outputLabel id="id17" for="homeDirectory" value="homeDirectory" />
												<h:panelGroup id="id18">
													<h:inputText id="homeDirectory"
														style="width: 500px;margin-right:15px"
														value="#{LdapGruppenForm.myLdapGruppe.homeDirectory}"
														required="true" />
													<x:message id="id19" for="homeDirectory" style="color: red"
														replaceIdWithLabel="true" />
												</h:panelGroup>
												...
												<h:outputLabel id="id23" for="objectClasses" value="objectClasses" />
												<h:panelGroup id="id24">
													<h:inputText id="objectClasses"
														style="width: 500px;margin-right:15px"
														value="#{LdapGruppenForm.myLdapGruppe.objectClasses}"
														required="true" />
													<x:message id="id25" for="objectClasses" style="color: red"
														replaceIdWithLabel="true" />
												</h:panelGroup>
												...
												<h:outputLabel id="id35" for="description" value="description" />
												...
												<h:outputLabel id="id38" for="displayName" value="displayName" />
												...
												<h:outputLabel id="id44" for="loginShell" value="loginShell" />
												...
												<h:outputLabel id="id47" for="sambaAcctFlags" value="sambaAcctFlags" />
												<h:panelGroup id="id48">
													<h:inputText id="sambaAcctFlags"
														style="width: 500px;margin-right:15px"
														value="#{LdapGruppenForm.myLdapGruppe.sambaAcctFlags}"
														required="true" />
													<x:message id="id49" for="sambaAcctFlags" style="color: red"
														replaceIdWithLabel="true" />
												</h:panelGroup>
												...
												<h:panelGroup id="id51">
													<h:inputText id="sambaLogonScript"
														...
														required="true" />
													<x:message id="id52" for="sambaLogonScript" style="color: red"
														replaceIdWithLabel="true" />
												</h:panelGroup>
												...
												<h:panelGroup id="id54">
													<h:inputText id="sambaPrimaryGroupSID"
														...
														required="true" />
													<x:message id="id55" for="sambaPrimaryGroupSID" style="color: red"
														replaceIdWithLabel="true" />
												</h:panelGroup>
												...
												<h:panelGroup id="id57">
													<h:inputText id="sambaPwdMustChange"
														...
														required="true" />
													<x:message id="id58" for="sambaPwdMustChange" style="color: red"
														replaceIdWithLabel="true" />
												</h:panelGroup>
												...
												<h:panelGroup id="id60">
													<h:inputText id="sambaPasswordHistory"
														...
														required="true" />
													<x:message id="id61" for="sambaPasswordHistory" style="color: red"
														replaceIdWithLabel="true" />
												</h:panelGroup>
												...
												<h:panelGroup id="id63">
													<h:inputText id="sambaLogonHours"
														...
														required="true" />
													<x:message id="id64" for="sambaLogonHours" style="color: red"
														replaceIdWithLabel="true" />
												</h:panelGroup>
												...
												<h:panelGroup id="id66">
													<h:inputText id="sambaKickoffTime"
														...
														required="true" />
													<x:message id="id67" for="sambaKickoffTime" style="color: red"
														replaceIdWithLabel="true" />
												</h:panelGroup>
