...
<%-- ######################################## 
							...
							Alle Benutzer in der Ã?bersicht
		...
		<htm:tr>
			...
			<htm:td valign="top" styleClass="layoutInhalt">
				...
				<h:form id="modulform">
					...
					<h:panelGroup id="id4" rendered="#{LoginForm.maximaleBerechtigung == 1}">
						...
						<htm:table border="0" align="center" width="100%" cellpadding="15">
							<htm:tr>
								<htm:td>
									...
									<h:messages id="id6" globalOnly="true" errorClass="text_red"
									...
									<x:dataTable id="benutzerliste" styleClass="standardTable"
										...
										<h:column id="id13">
											...
											<h:outputText id="id15" value="#{item.moduleClient.status}" />
										</h:column>

										<h:column id="id16" rendered="#{ModuleServerForm.running==true}">
											<f:facet name="header">
												<h:outputText id="id17" value="#{msgs.shortsession}" />
											</f:facet>
											<h:commandLink id="id18" action="#{ModuleServerForm.startModule}"
											...
											<h:commandLink id="id19" action="#{ModuleServerForm.stopModule}"
												rendered="#{item.moduleClient.status=='active'}"
												title="shutdown">
												<h:graphicImage id="id20" value="/newpages/images/icons/stop_task.gif" />
												<x:updateActionListener value="#{item}"
													property="#{ModuleServerForm.myModule}" />
											</h:commandLink>
											<h:commandLink
