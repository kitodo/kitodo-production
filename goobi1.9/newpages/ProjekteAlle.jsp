					...
					<htm:table border="0" align="center" width="100%" cellpadding="15">
						<htm:tr>
							<htm:td>
								...
								<%-- Neu-Schaltknopf --%>
								<h:commandLink id="id5" action="#{ProjekteForm.Neu}" immediate="true"
								...
								<x:dataTable id="id8" styleClass="standardTable" width="100%"
								    ...
								    <%-- +++++++++++++++++  FileFormats ++++++++++++++++++++++++ --%>
                                     <x:column id="id20" style="text-align:center">
                                        <f:facet name="header">
                                            <h:outputText id="id21" value="#{msgs.internesSpeicherformat}" />
                                        </f:facet>
                                    ...
                                    <x:column id="id234" style="text-align:center">
                                        <f:facet name="header">
                                         ...
                                         <h:graphicImage id="id2341" value="/newpages/images/check_true.gif"
								            rendered="#{item.projectIsArchived}" />
								        <h:graphicImage id="id2342" value="/newpages/images/check_false.gif"
								            rendered="#{!item.projectIsArchived}" />>
                                    </x:column>
									<x:column id="id26" style="text-align:center"
										...
										<h:commandLink id="id28" action="ProjekteBearbeiten"
											...
											<h:graphicImage id="id29" value="/newpages/images/buttons/edit.gif" />
