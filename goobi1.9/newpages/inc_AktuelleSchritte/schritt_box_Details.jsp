	...
	<htm:tr>
		<htm:td styleClass="main_statistikboxen_row2">
			...
			<htm:table border="0" width="90%" cellpadding="2">
				...
				<htm:tr
					rendered="#{AktuelleSchritteForm.mySchritt.bearbeitungsbeginn !=null && !HelperForm.anonymized}">
					<htm:td width="150">
				...
				<htm:tr
					rendered="#{AktuelleSchritteForm.mySchritt.bearbeitungszeitpunkt !=null && !HelperForm.anonymized}">
					<htm:td width="150">
