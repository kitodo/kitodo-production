...
<h:panelGrid id="aslsid2" width="100%" columnClasses="standardTable_Column,standardTable_ColumnRight" rowClasses="standardTable_Row_bottom"
	...
	<h:panelGroup id="aslsid4" >
		...
		<h:outputText id="aslsid6sdf" value="#{msgs.showArchivedProjects}:"  />
		<x:selectBooleanCheckbox id="check1" forceId="true" value="#{Form.showArchivedProjects}" onchange="document.getElementById('FilterAlle').click()" style="margin-right:40px" />
