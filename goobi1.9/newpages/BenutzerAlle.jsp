							...
							<htm:td>
								...
								<h:panelGrid id="id8" width="100%"
									...
									<h:panelGroup id="id9">
										...
										<h:inputText id="id12" value="#{BenutzerverwaltungForm.filter}"
										...
										<h:commandLink
											...
											<h:graphicImage id="id13" value="/newpages/images/buttons/reload.gif" />
										</h:commandLink>
								...
								<x:dataTable id="id14" styleClass="standardTable" width="100%"
									...
									<h:column id="id15">
										...
										<h:outputText id="id17" value="#{item.nachname}, #{item.vorname}"
									...
									<h:column id="id21">
										...
										<x:dataList id="id23" var="intern"
											...
											<h:outputText id="id25" value="," rendered="#{rowIndex + 1 < rowCount}" />
										</x:dataList>
									</h:column>
									...
									<h:column id="id26">
										...
										<x:dataList id="id28" var="intern"
											...
											<h:outputText id="id30" value="," rendered="#{rowIndex + 1 < rowCount}" />
										</x:dataList>
									</h:column>
									...
									<h:column
										...
										<h:commandLink id="id32" action="BenutzerBearbeiten"
											...
											<h:graphicImage id="id33" value="/newpages/images/buttons/edit.gif" />
