								...
								<htm:table cellpadding="3" cellspacing="0" width="100%"
											...
											<h:panelGrid id="id7" columns="2">
												...
												<h:panelGroup id="id9">
													<h:inputText id="sessiontimeout"
														...
														required="true" />
													<x:message id="id10" for="sessiontimeout" style="color: red"
												...
												<h:panelGroup id="id12">
													...
													<x:message id="id13" for="tabellengroesse" style="color: red"
														replaceIdWithLabel="true" />
												</h:panelGroup>
												...
												<h:panelGroup id="id15">
													<h:inputText id="metadatenSprache"
														...
														required="true" />
													<x:message id="id16" for="metadatenSprache" style="color: red"
														replaceIdWithLabel="true" />
												</h:panelGroup>

												<%-- CSS für den Nutzer --%>
												<h:outputLabel id="id17" for="css" value="#{msgs.farbschema}" />
									...
									<htm:tr>
										<htm:td styleClass="eingabeBoxen_row3" align="left">
											<h:commandButton id="id22" value="#{msgs.abbrechen}" action="newMain"
												immediate="true" />
										</htm:td>
