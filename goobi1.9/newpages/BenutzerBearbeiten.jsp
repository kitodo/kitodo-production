					...
					<h:form id="usereditform" onkeypress="ifEnterClick(event, 'usereditform:absenden');">
						...
						<h:panelGrid id="id0" width="100%" columns="1"
							...
							<h:panelGroup id="id1">
								...
								<h:commandLink id="id3" value="#{msgs.benutzerverwaltung}"
									action="BenutzerAlle" />
								<f:verbatim> &#8250;&#8250; </f:verbatim>
										...
										<htm:tr>
											<htm:td styleClass="eingabeBoxen_row2" colspan="2">
												...
												<h:panelGrid id="id12" columns="2" rowClasses="top">
													...
													<%-- nachname --%>
													<h:outputLabel id="id13" for="nachname"
														value="#{msgs.nachname}" />
													...
													<%-- vorname --%>
													<h:outputLabel id="id16" for="vorname"
														value="#{msgs.vorname}" />
													...
													<%-- standort --%>
													<h:outputLabel id="id19" for="standort"
														value="#{msgs.standort}" />
													...
													<%-- LdapGruppe --%>
													<h:outputLabel id="id28" for="ldapGruppe"
													...
													<h:panelGroup id="id35">
														<h:inputText id="metadatenSprache"
															...
															required="true" />
														<x:message id="id36" for="metadatenSprache"
															style="color: red" replaceIdWithLabel="true" />
													</h:panelGroup>

													<%-- ist aktiv --%>
													<h:outputLabel id="id37" for="istAktiv"
														value="#{msgs.istAktiv}" />
													...
													<h:panelGroup id="id41">
														...
														<x:message id="id42" for="mitMassendownload"
															style="color: red" replaceIdWithLabel="true" />
													</h:panelGroup>
