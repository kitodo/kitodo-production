						...
						<htm:td>
							...
							<x:dataTable id="id8" styleClass="standardTable" width="100%"
								...
								<x:column id="id15" style="text-align:center">
								        <f:facet name="header">
								            <h:outputText id="id16" value="#{msgs.metadatenSortierungNachRegelsatz}" />
								        </f:facet>
								        <h:graphicImage id="id17" value="/newpages/images/check_true.gif"
								            rendered="#{item.orderMetadataByRuleset}" />
								        <h:graphicImage id="id18" value="/newpages/images/check_false.gif"
								            rendered="#{!item.orderMetadataByRuleset}" />
								    </x:column>

								<h:column id="id19" rendered="#{(LoginForm.maximaleBerechtigung == 1) || (LoginForm.maximaleBerechtigung == 2)}">
									<f:facet name="header">
									...
									<h:commandLink id="id21" action="RegelsaetzeBearbeiten"
										...
										<h:graphicImage id="id22" value="/newpages/images/buttons/edit.gif" />
