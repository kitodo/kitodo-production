...
--
-- Migration: Create table task_x_folder

-- 1. Create table task_x_folder

-- -!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-R

CREATE TABLE task_x_folder (
  ...
  CONSTRAINT FK_task_x_folder_task_id
    FOREIGN KEY ( task_id ) REFERENCES task ( id ),
  CONSTRAINT FK_task_x_folder_folder_id
