...
public class ProcessProperty implements Serializable, GoobiPropertyInterface, Comparable<ProcessProperty> {
	...
	/**
	 * Fetter for data type set to private for hibernate, for use in program use getType instead.
	 * 
	...
	/**
	 * Set data type to defined integer. only for internal use through hibernate, for changing data type use
	 * setType instead.
	 * 
