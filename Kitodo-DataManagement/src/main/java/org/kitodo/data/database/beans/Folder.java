...
public class Folder extends BaseBean {
    ...
    /**
     * An encapsulation to access the content creation properties of a folder
     * from JSF.
     */
    @Transient
    ...
    /**
     * Returns an encapsulation to access the content creation properties of a
     * folder from JSF.
     *
    ...
    public Object getGenerator() {
        try {
            if (generator == null) {
                generator = Class.forName("org.kitodo.forms.GeneratorSelect").getConstructor(Folder.class)
                        .newInstance(this);
            }
            return generator;
