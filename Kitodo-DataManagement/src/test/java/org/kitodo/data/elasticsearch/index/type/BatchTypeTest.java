...
public class BatchTypeTest {
    ...
    private static List<Batch> prepareData() {
        ...
        firstBatch.setType(org.kitodo.data.database.helper.enums.BatchType.LOGISTIC);
        ...
        thirdBatch.setType(org.kitodo.data.database.helper.enums.BatchType.LOGISTIC);
