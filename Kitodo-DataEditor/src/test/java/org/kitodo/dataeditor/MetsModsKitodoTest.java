...
public class MetsModsKitodoTest {
    ...
    @Test
    public void createMetsByFile() throws JAXBException, XMLStreamException {
    ...
    @Test
    public void readValues() throws JAXBException, XMLStreamException {
        MetsModsKitodo metsModsKitodo = new MetsModsKitodo(xmlfile);
    ...
    @Test
    public void readKitodoMetadata() throws JAXBException, XMLStreamException {
        MetsModsKitodo metsModsKitodo = new MetsModsKitodo(xmlfile);
    ...
    @Test
    public void readKitodoMetadataById() throws JAXBException, XMLStreamException {
        MetsModsKitodo metsModsKitodo = new MetsModsKitodo(xmlfile);
    ...
    public void readKitodoMetadataByIdFail() throws JAXBException, XMLStreamException {
        MetsModsKitodo metsModsKitodo = new MetsModsKitodo(xmlfile);
