...
public class ExportDocket{
	 ...
	 */
	public void startExport(DocketData docketData,OutputStream os, String xsltfile) throws IOException {
	...
	public void startExport(Iterable<DocketData> docketDataList, OutputStream os, String xsltfile) throws IOException {
	...
	public byte[] generatePdfBytes(ByteArrayOutputStream out, String xsltfile) throws IOException {
		// generate pdf file
