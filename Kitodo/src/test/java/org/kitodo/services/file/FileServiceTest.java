...
public class FileServiceTest {
    ...
    public void shouldCreateSymLink() throws IOException {
        ...
        File script = new File(ConfigCore.getParameter(Parameter.SCRIPT_CREATE_SYMLINK));
        ...
        File scriptClean = new File(ConfigCore.getParameter(Parameter.SCRIPT_DELETE_SYMLINK));
    ...
    public void shouldDeleteSymLink() throws IOException {
        ...
        File scriptPrepare = new File(ConfigCore.getParameter(Parameter.SCRIPT_CREATE_SYMLINK));
        URI directory = fileService.createDirectory(URI.create(""), "symLinkSource");
        fileService.createResource(directory, "meta.xml");
        User user = new User();
        user.setLogin(SystemUtils.USER_NAME);
        ...
        File script = new File(ConfigCore.getParameter(Parameter.SCRIPT_DELETE_SYMLINK));
        ExecutionPermission.setExecutePermission(script);
