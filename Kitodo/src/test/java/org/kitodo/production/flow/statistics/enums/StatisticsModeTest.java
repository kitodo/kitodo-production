...
public class StatisticsModeTest {
    ...
    // assertEquals("Duration of the steps",
    // StatisticsMode.SIMPLE_RUNTIME_STEPS.getTitle());
    // assertEquals("Production throughput",
    // StatisticsMode.THROUGHPUT.getTitle());
    ...
    // assertEquals("Production statistics",
    // StatisticsMode.PRODUCTION.getTitle());
