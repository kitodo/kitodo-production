...
<f:view locale="#{SpracheForm.locale}">
    ...
    <h:form id="formular1" style="margin:0px">
        <htm:table id="navigation" cellpadding="2" cellspacing="0"
                   style="position: fixed; margin-right: 4px; width:99,75%; top:0"
                        ...
                        <htm:tr>
                            ...
                            <htm:td align="right">
                                ...
                                <h:commandLink style="font-size:11px" action="#{Metadaten.Reload}"
                                               value="#{msgs.speichern}" rendered="#{not Metadaten.nurLesenModus}"
                                               immediate="false"/>
                                <h:outputText value=" | " style="font-size: 11px;"
                                              rendered="#{not Metadaten.nurLesenModus}"/>
                                <%-- Metadaten nicht schreiben, nur zurueck gehen--%>
        ...
        <htm:tr>
            <htm:td styleClass="main_statistikboxen_row3" height="1px" colspan="2">
                <h:form id="formular4" style="margin:0px">
                    <htm:table styleClass="main_statistikboxen_bottom" width="100%" cellspacing="0" cellpadding="0"
                               style="">
                        <htm:tr>
