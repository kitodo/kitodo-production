        ...
        <htm:tr>
            <htm:td styleClass="eingabeBoxen_row2">
                <h:panelGrid columns="2">
                    ...
                    <x:inputFileUpload id="fileupload" value="#{Metadaten.fileManipulation.uploadedFile}" storage="file"
                    ...
                    <h:selectOneMenu style="width:220px" value="#{Metadaten.fileManipulation.currentFolder}">
                        <si:selectItems value="#{Metadaten.allTifFolders}" var="folder" itemLabel="#{folder}"
                                        itemValue="#{folder}"/>
                    </h:selectOneMenu>

                    <h:outputLabel value="#{msgs.position}:" for="paginationSelection"
                                   rendered="#{Metadaten.alleSeiten != null}"/>
                    <h:selectOneMenu value="#{Metadaten.fileManipulation.insertPage}" id="paginationSelection"
                                     style="width:220px" rendered="#{Metadaten.alleSeiten != null}">
            ...
            <htm:td styleClass="eingabeBoxen_row2">
                <h:panelGrid columns="2" rowClasses="rowTop">
                    ...
                    <h:selectManyListbox style="height:300px;width:220px"
                        ...
                        <si:selectItems itemLabel="#{folder}" itemValue="#{folder}" var="folder"
