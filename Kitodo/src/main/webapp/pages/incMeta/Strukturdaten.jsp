        ...
        <htm:tr>
            <htm:td styleClass="eingabeBoxen_row2">
                <h:panelGrid id="mygrid1" columns="1">
                    ...
                    <x:selectOneRadio id="auswahlElementWohin" forceId="true" layout="pageDirection"
                    ...
                    <x:inputText id="secretElement" forceId="true" value="#{Metadaten.neuesElementWohin}"
                                 style="display:none;"/>
                        ...
                        <jd:hideableArea id="addZusaetzlicheDocstructs" saveState="view">
                            <h:panelGrid id="mygrid4" columns="2" style="margin-left:40px;" rowClasses="top"
                                ...
                                <h:selectOneMenu id="katalogauswahl" value="#{Metadaten.opacKatalog}"
                                    ...
                                    <si:selectItems value="#{ProzesskopieForm.allOpacCatalogues}" var="step"
            ...
            <htm:tr>
                <htm:td styleClass="eingabeBoxen_row1">
                    ...
                    <h:commandLink>
                        ...
                        <x:updateActionListener value="#{Metadaten.treeProperties.showpagesasajax?false:true}"
            ...
            <htm:tr>
                <htm:td styleClass="eingabeBoxen_row3">
                    <h:panelGrid id="mygrid6" columns="2" width="100%"
                                 columnClasses="standardTable_Column,standardTable_ColumnRight">
                        <a4j:commandLink action="#{Metadaten.SeitenVonChildrenUebernehmen}"
