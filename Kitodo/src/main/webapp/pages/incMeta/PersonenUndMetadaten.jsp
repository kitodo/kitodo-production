...
<h:panelGroup
        rendered="#{(not Metadaten.modusHinzufuegen) && (not Metadaten.modusHinzufuegenPerson) && (not Metadaten.addMetadataGroupMode)}">
                    ...
                    <htm:tr
                        ...
                        <htm:td rowspan="#{aGroup.rowspan}" rendered="#{member.first}"
                            ...
                            <h:commandLink action="#{aGroup.copy}"
                                           rendered="#{aGroup.copyable && not Metadaten.nurLesenModus}"
    ...
    <h:panelGroup rendered="#{!empty Metadaten.myMetadaten}"
        ...
        <%-- oeffnen der Tabelle --%>
        <x:dataTable value="#{Metadaten.myMetadaten}" var="Item" rowClasses="metadatenGrauBackground"
            ...
            <h:column>
                ...
                <h:selectManyListbox onselect="styleAnpassen(this)" value="#{Item.selectedItems}"
                                     ...
                                     readonly="#{Metadaten.nurLesenModus}">
                    <si:selectItems value="#{Item.items}" itemValue="#{element.label}" var="element"
    ...
    <htm:table width="540">
        <htm:tr>
            <htm:td>
                <h:panelGroup
                        rendered="#{not Metadaten.modusHinzufuegen && not Metadaten.modusHinzufuegenPerson && not Metadaten.addMetadataGroupMode && not Metadaten.nurLesenModus}"
