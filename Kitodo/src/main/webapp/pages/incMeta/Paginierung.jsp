...
<h:panelGrid id="mygrid10" columns="2" style="margin:0px;">
    ...
    <h:panelGrid id="mygrid11" columns="1" width="270px" style="margin:0px;">
        ...
        <h:panelGroup rendered="#{Metadaten.alleSeiten !=null}" style="position: fixed; top: 122px; left: 250px;">
            <htm:table cellpadding="3" cellspacing="0" id="PaginierungActionBox"
                ...
                <htm:tr>
                    <htm:td styleClass="eingabeBoxen_row2">
                        ...
                        <a4j:commandLink id="s4" action="#{Metadaten.Paginierung}" style="margin-top:15px"
                                         reRender="PaginierungAlleImages,myMessages,mygrid10">
                        ...
                        <a4j:commandLink id="s5" action="#{Metadaten.Paginierung}" style="margin-top:15px"
                                         reRender="PaginierungAlleImages,myMessages,mygrid10">
            ...
            <htm:table cellpadding="3" cellspacing="0" id="pageOrder" styleClass="eingabeBoxen"
                       style="width: 320px;margin-top:10px;" rendered="#{Metadaten.displayFileManipulation}">
                <htm:tr>
                    <htm:td styleClass="eingabeBoxen_row1">
