...
<h:form id="formularBild">
    ...
    <x:panelGrid id="BildArea" forceId="true" columns="1" rendered="#{Metadaten.bildNummer != '-1'}">
        ...
        <h:panelGroup style="text-align: center">
            ...
            <x:inputText id="txtZoom2" forceId="true" value="#{Metadaten.bildGroesse}"
            ...
            <%-- rotation --%>
            <a4j:commandLink reRender="BildArea,myBild,imageform" action="#{Metadaten.rotateLeft}" id="rotateLeft"
            ...
            <a4j:commandLink reRender="BildArea,myBild,imageform" action="#{Metadaten.rotateRight}" id="rotateRight"
            ...
            <%-- OCR --%>
            <a4j:commandLink reRender="BildArea,myBild" id="ocrButton" action="#{Metadaten.showOcrResult}"
...
<h:form id="formularOrdner" style="margin-top:15px">
    <h:panelGrid columns="3">
        ...
        <h:outputText value="#{msgs.noFileSelected}"
                      rendered="#{Metadaten.alleSeiten != null && Metadaten.checkForRepresentative && empty Metadaten.currentRepresentativePage}"/>
        <h:outputText value="#{Metadaten.alleSeiten[Metadaten.currentRepresentativePage].label}"
                      rendered="#{Metadaten.alleSeiten != null && Metadaten.checkForRepresentative && not empty Metadaten.currentRepresentativePage}"/>
