        ...
        <htm:td styleClass="eingabeBoxen_row2">
            ...
            <h:panelGrid id="uaid3" columns="8"
                ...
                <h:panelGroup id="uaid5">
                    <x:inputCalendar id="from" style="width:110px" value="#{Form.statisticsManager1.sourceDateFrom}"
                                     renderAsPopup="true"
                ...
                <h:panelGroup id="uaid7">
                    <x:inputCalendar id="to" style="width:110px" value="#{Form.statisticsManager1.sourceDateTo}"
                ...
                <h:selectOneMenu id="uaid10" style="width:130px" value="#{Form.statisticsManager1.sourceTimeUnit}"
                    ...
                    <si:selectItems id="uaid11" value="#{Form.statisticsManager1.allTimeUnits}" var="unit"
                ...
                <h:selectOneMenu id="uaid16" style="width:130px" value="#{Form.statisticsManager1.targetTimeUnit}"
                                 converter="StatisticsTimeUnitConverter">
                    <si:selectItems id="uaid17" value="#{Form.statisticsManager1.allTimeUnits}" var="unit"
                                    itemLabel="#{unit.title}" itemValue="#{unit}"/>
                </h:selectOneMenu>
                ...
                <h:selectOneMenu id="uaid19" style="width:130px"
                    ...
                    <si:selectItems id="uaid20" value="#{Form.statisticsManager1.allCalculationUnits}" var="unit"
                                    itemLabel="#{unit.title}" itemValue="#{unit}"/>
                </h:selectOneMenu>
                ...
                <h:selectOneMenu id="uaid22" style="width:130px" value="#{Form.statisticsManager1.targetResultOutput}"
                    ...
                    <si:selectItems id="uaid23" value="#{Form.statisticsManager1.allResultOutputs}" var="out"
...
<h:panelGroup
        rendered="#{Form.statisticsManager1 != null && !Form.statisticsManager1.statisticMode.isSimple && Form.showStatistics}">
