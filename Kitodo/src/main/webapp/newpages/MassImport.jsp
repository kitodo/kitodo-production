                                ...
                                <htm:table cellpadding="3" cellspacing="0" width="100%" styleClass="eingabeBoxen"
                                    ...
                                    <htm:tr>
                                        <htm:td styleClass="eingabeBoxen_row2" colspan="2">
                                            ...
                                            <x:panelTabbedPane serverSideTabSwitch="true" immediateTabChange="false"
                                                ...
                                                <x:panelTab label="#{msgs.recordImport}" id="record">
                                                    <h:panelGrid columns="2" width="100%" border="0"
                                                                 style="font-size:12;margin-left:30px"
                                                                 rowClasses="rowTop"
                                                ...
                                                <x:panelTab label="#{msgs.uploadImport}" id="upload">
                                                    ...
                                                    <h:panelGrid columns="2" width="100%" border="0"
                                                        ...
                                                        <h:selectOneMenu id="katalogauswahl"
                                                                         ...
                                                                         styleClass="processMassImport">
                                                            <si:selectItems value="#{MassImportForm.allOpacCatalogues}"
                                                        ...
                                                        <h:panelGroup>
                                                            <x:inputFileUpload id="fileupload3"
                                                ...
                                                <x:panelTab label="#{msgs.folderImport}" id="folder">
                                                    <h:panelGrid columns="2" width="100%" border="0"
                                                        ...
                                                        <h:selectManyListbox value="#{MassImportForm.selectedFilenames}"
                                                                             ...
                                                                             styleClass="processMassImport"
                                                                             style="height: 300px;">
                                                            <si:selectItems itemLabel="#{file}" itemValue="#{file}"
                                                                            var="file"
