...
<h:panelGrid id="myFilterGrid" width="100%" columnClasses="standardTable_ColumnRight" rowClasses="standardTable_Row"
             columns="1">
...
<h:panelGrid id="aslsid2" width="100%" columnClasses="standardTable_Column,standardTable_ColumnRight"
             rowClasses="standardTable_Row"
             columns="2">
    ...
    <h:panelGroup id="aslsid4">
        ...
        <x:commandButton type="submit" id="FilterAlle" forceId="true" style="display:none"
                         action="#{Form.FilterAlleStart}"/>

        <h:commandLink id="aslsid9" action="#{Form.FilterAlleStart}" title="#{msgs.filterAnwenden}"
                       style="margin-left:5px">
            <h:graphicImage id="aslsid10" alt="reload" value="/newpages/images/buttons/reload.gif"/>
        </h:commandLink>

        <h:outputLink id="aslsid11" target="_blank"
                      value="https://github.com/kitodo/kitodo-production/wiki/Suche-und-Filtern">
            <h:graphicImage id="aslsid12" alt="help" title="#{msgs.hilfeZumFilter}"
...
<h:panelGrid id="myFilterGrid" width="100%" columnClasses="standardTable_ColumnRight" rowClasses="standardTable_Row_bottom" columns="1">
	<h:panelGroup id="myFilter">
		...
		<h:commandLink id="newFilterubid11" action="#{Form.user.addFilter}" title="#{msgs.addFilter}" style="margin-left:5px">
			<h:graphicImage id="newFilterubid12" alt="Filter" value="/newpages/images/buttons/reload.gif" />
		</h:commandLink>

		<h:commandLink id="removeFilterubid11" action="#{Form.user.removeFilter}" title="#{msgs.removeFilter}" style="margin-left:5px">
			<h:graphicImage id="removeFilterubid12" alt="Filter" value="/newpages/images/buttons/reload.gif" />
		</h:commandLink>
	</h:panelGroup>
</h:panelGrid>
--%>
