...
--%>
    <htm:table cellspacing="1px" cellpadding="1px" width="100%" styleClass="standardTable"
        ...
        <x:dataList var="container" value="#{AktuelleSchritteForm.containerList}" rowCountVar="rowCount"
                    rowIndexVar="rowIndex">
            <x:dataList var="proc" value="#{AktuelleSchritteForm.containerlessProperties}" rowCountVar="propCount"
                        rowIndexVar="propInd">
                <htm:tr styleClass="standardTable_Row1" rendered="#{container==0 }">
                    ...
                    <htm:td styleClass="standardTable_ColumnCentered">
                        ...
                        <h:commandLink action="AktuelleSchritteBearbeiten" title="#{msgs.bearbeiten}"
                            ...
                            <x:updateActionListener property="#{AktuelleSchritteForm.modusBearbeiten}"
                                                    value="eigenschaft"/>
            ...
            <x:dataList var="process_item" value="#{AktuelleSchritteForm.containers[container].propertyList}"
                ...
                <htm:tr styleClass="standardTable_Row1" rendered="#{container!=0 }">
                    ...
                    <htm:td styleClass="standardTable_ColumnCentered"
                            ...
                            rendered="#{propInd ==0}">
                        <h:panelGroup
                                rendered="#{AktuelleSchritteForm.mySchritt.processingUser.id == LoginForm.myBenutzer.id && process_item.currentStepAccessCondition != 'READ'}">
                            <h:commandLink action="AktuelleSchritteBearbeiten" title="#{msgs.bearbeiten}">
                                <h:graphicImage value="/newpages/images/buttons/edit.gif"/>
                                <x:updateActionListener property="#{AktuelleSchritteForm.container}"
                                                        value="#{container}"/>
                                <x:updateActionListener property="#{AktuelleSchritteForm.modusBearbeiten}"
                                                        value="eigenschaft"/>
                                <a4j:support event="onchange" reRender="editBatch"/>
                            ...
                            <htm:td>
                                ...
                                <h:panelGroup id="prpvw15_2" rendered="#{(myprocess_item.type.name == 'list')}">
                                    <h:selectOneMenu value="#{myprocess_item.value}"
                                                     ...
                                                     readonly="#{myprocess_item.currentStepAccessCondition == 'READ'}">
                                        <si:selectItems id="prpvw15_2_2" value="#{myprocess_item.possibleValues}"
                                ...
                                <h:panelGroup id="prpvw15_3"
                                    ...
                                    <h:selectManyListbox id="prpvw15_3_1" style="width: 500px;margin-right:15px"
                                                         ...
                                                         readonly="#{myprocess_item.currentStepAccessCondition == 'READ'}">
                                        <si:selectItems id="prpvw15_3_2" value="#{myprocess_item.possibleValues}"
                                                        var="myprocess_items" itemLabel="#{myprocess_items}"
                                                        itemValue="#{myprocess_items}"/>
                                    </h:selectManyListbox>
                                </h:panelGroup>
