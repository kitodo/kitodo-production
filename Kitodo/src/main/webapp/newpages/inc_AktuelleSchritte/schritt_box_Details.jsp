                    ...
                    <htm:td styleClass="main_statistikboxen_row2">
                        ...
                        <htm:table border="0" width="90%" cellpadding="2">
                            ...
                            <htm:tr>
                                ...
                                <htm:td>
                                    <h:outputText value="#{AktuelleSchritteForm.mySchritt.priority}"
                                                  rendered="#{AktuelleSchritteForm.mySchritt.priority!=10}"/>
                            ...
                            <htm:tr rendered="#{AktuelleSchritteForm.mySchritt.processingBegin !=null && !HelperForm.anonymized}">
                                ...
                                <htm:td>
                                    <h:outputText
                                            value="#{AktuelleSchritteForm.mySchritt.processingBeginAsFormattedString}"/>
                                </htm:td>
                            </htm:tr>
                            <htm:tr rendered="#{AktuelleSchritteForm.mySchritt.processingTime !=null && !HelperForm.anonymized}">
                                ...
                                <htm:td>
                                    <h:outputText
                                            value="#{AktuelleSchritteForm.mySchritt.processingTimeAsFormattedString}"/>
                                </htm:td>
                            </htm:tr>
