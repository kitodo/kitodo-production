    ...
    <htm:tr>
        <htm:td styleClass="eingabeBoxen_row2">
            <h:panelGrid columns="1">
                ...
                <%-- Upload-Schaltknopf --%>
                <h:commandLink
                        rendered="#{LoginForm.myBenutzer.withMassDownload && ProzessverwaltungForm.page.totalResults > 0 }"
                ...
                <h:panelGroup
                        rendered="#{LoginForm.myBenutzer.withMassDownload && ProzessverwaltungForm.modusAnzeige=='aktuell' && ProzessverwaltungForm.page.totalResults > 0 }">
                ...
                <h:panelGroup
                        rendered="#{ProzessverwaltungForm.modusAnzeige=='aktuell'  && ProzessverwaltungForm.page.totalResults > 0 }">
                ...
                <h:panelGroup
                    ...
                    <jd:hideableArea id="anzahlen" saveState="view">
                        <h:panelGrid columns="1" style="margin-left:40px">
                            ...
                            <%-- Statistische Auswertung-Schaltknopf für Page--%>
                            <h:commandLink id="action21" action="#{ProzessverwaltungForm.CalcMetadataAndImagesPage}"
                                           title="#{msgs.trefferDieserSeite}">
                                <h:outputText value="- #{msgs.trefferDieserSeite}"/>
                            </h:commandLink>

                            <%-- Statistische Auswertung-Schaltknopf für gesamtes Trefferset --%>
                            <h:commandLink id="action22" action="#{ProzessverwaltungForm.CalcMetadataAndImagesHits}"
                                           title="#{msgs.gesamtesTrefferset}"
                                           onclick="if (!confirm('#{msgs.wirklichAusfuehren}?')) return">
                                <h:outputText value="- #{msgs.gesamtesTrefferset}"/>
                            </h:commandLink>
                    ...
                    <jd:hideableArea id="statistik" saveState="view">
                        <h:panelGrid columns="1" style="margin-left:40px">
                            ...
                            <h:commandLink id="action30" rendered="#{!HelperForm.anonymized}"
                                ...
                                <x:updateActionListener property="#{ProzessverwaltungForm.showStatistics}"
                                                        value="true"/>
                            </h:commandLink>
                ...
                <h:panelGroup>
                    ...
                    <jd:hideableArea id="changeSearch" saveState="view">
                        ...
                        <h:commandLink action="#{ProzessverwaltungForm.FilterAlleStart}" style="margin-left:44px"
                ...
                <h:panelGroup>
                    ...
                    <jd:hideableArea id="changeView" saveState="view">
                        ...
                        <h:commandLink action="#{NavigationForm.Reload}" id="reloadcheck" style="margin-left:44px"
                                       title="#{msgs.uebernehmen}">
                            <h:outputText value="#{msgs.uebernehmen}"/>
                        </h:commandLink>
                    </jd:hideableArea>
