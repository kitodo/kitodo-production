...
<htm:table cellspacing="1px" cellpadding="1px" width="100%" styleClass="standardTable"
    ...
    <x:dataList var="container" value="#{ProzessverwaltungForm.containerList}" rowCountVar="rowCount"
                rowIndexVar="rowIndex">
        <x:dataList var="proc" value="#{ProzessverwaltungForm.containerlessProperties}" rowCountVar="propCount"
                    rowIndexVar="propInd">
        ...
        <x:dataList var="process_item" value="#{ProzessverwaltungForm.containers[container].propertyList}"
