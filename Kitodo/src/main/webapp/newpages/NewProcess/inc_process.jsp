...
<h:panelGrid columns="3" border="0" width="90%" align="center" rowClasses="rowMiddle"
    ...
    <h:panelGroup rendered="#{ProzesskopieForm.useOpac}">
        ...
        <h:selectOneMenu id="katalogauswahl" value="#{ProzesskopieForm.opacKatalog}"
            ...
            <si:selectItems value="#{ProzesskopieForm.allOpacCatalogues}" var="step" itemLabel="#{step}"
                            itemValue="#{step}"/>
        </h:selectOneMenu>
...
<h:panelGrid columns="2" width="100%" border="0" style="font-size:12;margin-left:30px" rowClasses="rowTop"
    ...
    <h:selectOneMenu value="#{ProzesskopieForm.docType}" rendered="#{ProzesskopieForm.standardFields.doctype}"
        ...
        <si:selectItems value="#{ProzesskopieForm.allDoctypes}" var="step" itemLabel="#{step.localizedLabel}"
    ...
    <h:selectManyListbox id="digitaleKollektionen" styleClass="prozessKopieFeldbreite"
        ...
        <si:selectItems value="#{ProzesskopieForm.possibleDigitalCollections}" var="step" itemLabel="#{step}"
                        itemValue="#{step}"/>
    </h:selectManyListbox>
