                                ...
                                <htm:tr style="vertical-align:top">
                                    ...
                                    <htm:td width="50%">
                                        ...
                                        <h:form>
                                            ...
                                            <htm:table cellspacing="1px" cellpadding="1px" width="100%"
                                                ...
                                                <x:dataList var="container"
                                                    ...
                                                    <x:dataList var="proc"
                                                        ...
                                                        <htm:tr styleClass="standardTable_Row1"
                                                                rendered="#{container!=0 }">
                                                            <htm:td>
