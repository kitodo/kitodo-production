...
<h:dataTable var="docstruct" id="docstructs" value="#{MassImportForm.docstructs}" headerClass="Tabelle2">
    ...
    <h:column>
        ...
        <h:selectOneMenu value="#{docstruct.docStruct}">
            <si:selectItems value="#{MassImportForm.plugin.possibleDocstructs}" itemLabel="#{test}" itemValue="#{test}"
                            var="test"/>
        </h:selectOneMenu>
    </h:column>
    ...
    <h:column>
        ...
        <h:selectOneMenu value="#{docstruct.volumeProperty.value}" id="prpvw15_2">
            <si:selectItems id="prpvw15_2_2" value="#{docstruct.volumeProperty.possibleValues}" var="props"
                            itemLabel="#{props}" itemValue="#{props}"/>
        </h:selectOneMenu>
    ...
    <h:column>
        ...
        <h:selectOneMenu value="#{docstruct.copyProperty.value}" id="prpvw15_1">
            <si:selectItems id="prpvw15_1_2" value="#{docstruct.copyProperty.possibleValues}" var="props"
                            itemLabel="#{props}" itemValue="#{props}"/>
        </h:selectOneMenu>
