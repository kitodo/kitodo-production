...
package de.sub.kitodo.metadaten.copier;
...
public class ComposeFormattedRule extends DataCopyrule {
     ...
     * @see de.sub.kitodo.metadaten.copier.DataCopyrule#apply(de.sub.kitodo.metadaten.copier.CopierData)
     */
    @Override
     ...
     * @see de.sub.kitodo.metadaten.copier.DataCopyrule#getMaxObjects()
     */
    @Override
     ...
     *
     * @return always 2
     * @see de.sub.kitodo.metadaten.copier.DataCopyrule#getMinObjects()
     */
    @Override
     ...
     *
     * @see de.sub.kitodo.metadaten.copier.DataCopyrule#setObjects(java.util.List)
     */
    @Override
     ...
     *
     * @see de.sub.kitodo.metadaten.copier.DataCopyrule#setSubject(java.lang.String)
     */
    @Override
