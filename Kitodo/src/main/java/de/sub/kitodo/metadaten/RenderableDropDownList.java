...
import org.kitodo.api.display.Item;
import org.kitodo.api.display.enums.DisplayType;
...
public class RenderableDropDownList extends RenderableMetadatum
     ...
     * @param data
     *            data to add
     * @see de.sub.kitodo.metadaten.RenderableGroupableMetadatum#addContent(ugh.dl.Metadata)
     */
    @Override
     ...
     * @see de.sub.kitodo.metadaten.SingleValueRenderableMetadatum#getValue()
     */
    @Override
     ...
     * @see de.sub.kitodo.metadaten.SingleValueRenderableMetadatum#setValue(java.lang.String)
     */
    @Override
     ...
     * @see de.sub.kitodo.metadaten.RenderableGroupableMetadatum#toMetadata()
     */
    @Override
