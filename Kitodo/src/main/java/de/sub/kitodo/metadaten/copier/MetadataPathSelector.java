...
public class MetadataPathSelector extends MetadataSelector {
     ...
     * @see de.sub.kitodo.metadaten.copier.MetadataSelector#createIfPathExistsOnly(CopierData,
     *      DocStruct, String)
     */
    @Override
     ...
     * @param value
     *            value to write
     * @see de.sub.kitodo.metadaten.copier.MetadataSelector#createOrOverwrite(CopierData,
     *      DocStruct, String)
     */
    @Override
     ...
     *
     * @see de.sub.kitodo.metadaten.copier.MetadataSelector#findAll(ugh.dl.DocStruct)
     */
    @Override
     ...
     *
     * @see de.sub.kitodo.metadaten.copier.MetadataSelector#findIn(ugh.dl.DocStruct)
     */
    @Override
