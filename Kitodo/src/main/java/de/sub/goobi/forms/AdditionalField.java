...
public class AdditionalField {
    ...
    public AdditionalField(CopyProcess copyProcess) {
    ...
    public boolean getShowDependingOnDoctype() {
        ...
        if (!this.isdoctype.equals("") && !StringUtils.containsIgnoreCase(isdoctype, this.copyProcess.getDocType())) {
            return false;
        }

        /* wenn nur "darf nicht" angegeben wurde */
        return !(!this.isnotdoctype.equals("") && StringUtils.containsIgnoreCase(isnotdoctype, this.copyProcess.getDocType()));
    }
