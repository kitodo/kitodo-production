...
public class SpracheForm {
	...
	/**
	 * The function getSupportedLocales() returns a list of maps, each representing one locale configured in the
	 * faces-config.xml file. Each of the maps will contain the fields
	 *
	 * <p>id − the locale’s ID String, e.g. “fr” or “en_GB”</p>
	 *
	 * <p>displayLanguageSelf − the name of the language in the language itself, e.g. “English”, “Deutsch”, “français”,
	 * “español”, “русский”, “日本語”, …</p>
	 *
	 * <p>It’s a good practice to identify a language in its own spelling, since this will be most likely what a speaker
	 * of that language will recognize. See also: http://www.cs.tut.fi/~jkorpela/flags.html Note that capitalisation is
	 * subject to the respective language. If the language is unknown, the id will be returned.</p>
	 *
	 * <p>displayLanguageTranslated − the name of the language in the currently selected language, e.g., if the current
	 * language is English: “English”, “German”, “French”, …</p>
	 *
	 * <p>This is just a nice feature because the language names are provided by Java; and it’s used in the mouse-over
	 * titles, so you can find out what e.g. “हिंदी” means, even if you don’t have a clue of the glyphs used. If no
	 * translations are available, this will fall back to English.</p>
	 *
	 * <p>selected − whether this is the current language</p>
	 *
	 * <p>This can be used for a sophisticated layout.</p>
	 *
	 ...
	 *
	 * @param langCodeCombined This parameter can be either of form “‹language›” or of form “‹language›_‹country›”,
	 * 							e.g. “en” or “en_GB” are valid values.
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * The function getGroupingSeparator() returns the character used for thousands separator for the current locale as
	 * read-only property "groupingSeparator".
	 *
