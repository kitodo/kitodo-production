...
public class SpracheForm {
    ...
    /**
     * The function getSupportedLocales() returns a list of maps, each representing one locale configured in
     * the faces-config.xml file. Each of the maps will contain the fields.
     * id − the locale’s ID String, e.g. “fr” or “en_GB”
     * displayLanguageSelf − the name of the language in the language itself, e.g. “English”, “Deutsch”, “français”,
     * “español”, “русский”, “日本語”, …
     *
     * <p>It’s a good practice to identify a language in its own spelling, since this will be most likely what
     * a speaker of that language will recognize.
     * See also: http://www.cs.tut.fi/~jkorpela/flags.html Note that capitalisation is subject to
     * the respective language. If the language is unknown, the id will be returned.
     * displayLanguageTranslated − the name of the language in the currently selected language,
     * e.g., if the current language is English: “English”, “German”, “French”, …</p>
     *
     * <p>This is just a nice feature because the language names are provided by Java; and it’s used in
     * the mouse-over titles, so you can find out what  e.g. “हिंदी” means, even if you don’t have a clue
     * of the glyphs used. If no translations are available, this will fall back to English.
     * selected − whether this is the current language</p>
     *
    ...
    public List<Map<String, Object>> getSupportedLocales() {
        ...
        // It seems we have an old Faces API, Faces 2.1’s getSupportedLocales() returns Iterator<Locale>
        // TODO: Update JSF API
     ...
     *            This parameter can be either of form “‹language›” or of form “‹language›_‹country›”,
