...
/**
 * The class DateUtils contains an omnium-gatherum of functions that work on calendar dates. All functionality is
 * realized using the org.joda.time.* library.
 *
...
public class DateUtils {
	 ...
	 *
	 * <p>
	 * Example: Let the ordered data set contain: …, 5th May 1954, 20th May 1954, 13th October 1954, 5th February 1955,
	 * 23th March 1955, 15th October 1956, …. Then the function will return 10 (DateTimeConstants.OCTOBER) for
	 * 1954 and 3 (DateTimeConstants.MARCH) for 1955.
	 * </p>
	 *
	 * @param data an ordered set of dates
	...
	/**
	 * The function sameMonth() compares two LocalDate objects in regard to the question whether their two dates
	 * reside in the same month of the calendar system presumed. Two dates are considered to be in the same month
	 * exactly if both their year and month of year fields are equal.
	 *
	 * @param compared date to compare against
	 * @param comparee date to compare, may be null
	...
	/**
	 * The function sameYear() compares two LocalDate objects in regard to the question whether their two dates reside
	 * in the same year of the calendar system presumed. Two dates are considered to be in the same year exactly
	 * if none of them is null and their year fields are equal.
	 *
	 * @param current date to compare against
	 * @param next date to compare, may be null
