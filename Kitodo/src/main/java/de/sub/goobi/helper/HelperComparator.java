...
public class HelperComparator implements Comparator<Object>, Serializable {
    ...
    private int compareMetadata(Object o1, Object o2) {
        ...
        String name1 = s1.getType().getNameByLanguage((String) Helper.getManagedBeanValue(
        		"#{LoginForm.myBenutzer.metadataLanguage}"));
        String name2 = s2.getType().getNameByLanguage((String) Helper.getManagedBeanValue(
                "#{LoginForm.myBenutzer.metadataLanguage}"));
        if (name1 == null) {
    ...
    private int compareDocStructTypen(Object o1, Object o2) {
        ...
        String name1 = s1.getNameByLanguage((String) Helper.getManagedBeanValue(
                "#{LoginForm.myBenutzer.metadataLanguage}"));
        String name2 = s2.getNameByLanguage((String) Helper.getManagedBeanValue(
                "#{LoginForm.myBenutzer.metadataLanguage}"));
        if (name1 == null) {
            name1 = "";
        }
