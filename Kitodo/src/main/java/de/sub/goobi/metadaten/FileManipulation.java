...
public class FileManipulation {
    ...
    public List<URI> getAllImportFolder() {
        URI tempDirectory = new File(
                ConfigCore.getParameter(Parameter.DIR_TEMP, DefaultValues.TEMPFOLDER)).toURI();
    ...
    public void importFiles() throws IOException {
        ...
        String tempDirectory = ConfigCore.getParameter(Parameter.DIR_TEMP, DefaultValues.TEMPFOLDER);

        String masterPrefix = "";
        boolean useMasterFolder = false;
        if (ConfigCore.getBooleanParameter(Parameter.USE_ORIG_FOLDER, true)) {
            useMasterFolder = true;
            masterPrefix = ConfigCore.getParameter(Parameter.DIRECTORY_PREFIX,
    ...
    private static boolean matchesFileConfiguration(URI file) {
        ...
        String prefix = ConfigCore.getParameter(Parameter.IMAGE_PREFIX, DefaultValues.IMAGE_PREFIX);
