...
/**
 * The Granularity indicates one out of six options how a course of appearance of a newspaper can be broken into
 ...
 * <dt>WEEKS</dt>
 * <dd>All issues of a week are scanned in one process. A week starts on Mondays. Keep in mind that week borders do not
 * necessarily match month and not even year borders.</dd>
 * <dt>MONTHS</dt>
...
public enum Granularity {
	...
	/**
	 * The function format() converts a given LocalDate to a String representation of the date in the given
	 * granularity. For the 1st January 2000 it will return:
	 *   • for DAYS:     2000-01-01
	 *   • for WEEKS:    1999-W52
	 *   • for MONTHS:   2000-01
