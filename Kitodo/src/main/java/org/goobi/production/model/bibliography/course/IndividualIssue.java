...
public class IndividualIssue {
    ...
    /**
     * Returns an integer which, for a given Granularity, shall indicate for two neighbouring individual
	 * issues whether they form the same process (break mark is equal) or to different processes
     * (break mark differs).
     *
     * @param mode
    ...
    /**
     * The function getGenericFields() returns a map with generic fields that can be configured for
     * process title creation in goobi_projects.xml. It provides the issue information in the following fields:
     *
     * <dl>
     * <dt><code>#DAY</code></dt>
    ...
    /**
     * The function indexIn() returns the index of the first occurrence of the block of this issue in
     ...
     * of this issue that is easy for a person to read.
     *
    ...
    /**
     * Returns a hash code for the object which depends on the content of its variables.
     * Whenever IndividualIssue objects are held in HashSet objects, a hashCode() is essentially necessary.
     *
     * <p>
     * The method was generated by Eclipse using right-click → Source → Generate hashCode() and equals()….
     * If you will ever change the classes’ fields, just re-generate it.
     * </p>
     *
