...
/**
 * This interface defines the required methods for any implementations of statistical requests to be used with
 * the StatisticalManager. There is an extension to this interface for implementations which needs time restriction to
 * be set.
 *
...
public interface IStatisticalQuestion {
	 ...
	 *
	 * @param dataSource add description
	 * @return List	&lt;DataTable&gt; add description
	 */
	...
	/**
	 * This method sets the calculation unit needed for specific requests. Since not all implementations will support
	 * this feature future implementations of this method will throw an UnsupportedOperationException
	 *
	 * @param cu add description
	 */
