...
public class PluginLoader {
	...
	/**
	 * The function getCataloguePluginForCatalogue() returns a redirection class to handle the first plug-in
	 * implementation object that positively responds to <code>supportsCatalogue(catalogue)</code>.
	 *
	...
	/**
	 * @deprecated Using this function is discouraged. Use <code>getPlugins(Class)</code> instead.
	 */
	@Deprecated
	...
	/**
	 * @deprecated Using this function is discouraged. Use <code>getPluginByTitle(Class, String, Locale)</code> instead.
	 */
	@Deprecated
	...
	/**
	 * The function getPluginByTitle() loads all plug-ins implementing the given UnspecificPlugin class type and
	 * returns a redirection class to handle the first plug-in implementation object that responds to
	 ...
	 * </p>
	 *
	 * @param clazz UnspecificPlugin class type of the plug-ins to load
	 * @param title title the plug-in implementation object shall respond with
	 * @param language language the title is in (may be null)
	...
	/**
	 * The function getPluginConfiguration() creates a HashMap that is passed to the plug-ins upon creation to
	 * configure them. The plug-ins may or may not make use of the configuration provided.
	 *
	 * <p>
	 * This is intended to be used for <em>general</em> configuration (probably) suitable for all plug-in types. Use
	 * setters on the plug-ins to set type-specific settings.
	 * </p>
	 *
	...
	/**
	 * The function getPlugins() loads all plug-ins implementing the given UnspecificPlugin class type and returns
	 * a Collection of redirection classes, each to handle one plug-in implementation object.
	 *
	 * @param clazz UnspecificPlugin class type of the plug-ins to load
	 ...
	 *
	 * @param type ImportType of plug-ins to look for
	...
	/**
	 * The function getPluginLoader() returns a PluginManagerUtil suitable for loading plug-ins from the subdirectory
	 * defined by the given PluginType
	 *
	 * @param type plug-in type specifying the plug-in subdirectory to scan
