...
public class ProcessService {
	...
	public String getImagesDirectory(Process process) throws IOException, InterruptedException, SwapException, DAOException {
		String pfad = getProcessDataDirectory(process) + "images" + File.separator;
		FilesystemHelper.createDirectory(pfad);
		return pfad;
	}

	public String getSourceDirectory(Process process) throws IOException, InterruptedException, SwapException, DAOException {
		SafeFile dir = new SafeFile(getImagesDirectory(process));
		FilenameFilter filterVerz = new FilenameFilter() {
			@Override
			public boolean accept(File dir, String name) {
	...
	// backup of meta.xml
	private void createBackupFile(Process process) throws IOException, InterruptedException, SwapException, DAOException {
