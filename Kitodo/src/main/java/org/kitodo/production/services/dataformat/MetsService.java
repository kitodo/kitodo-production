...
public class MetsService {
    ...
    public Workpiece load(InputStream inputStream, InputStreamProviderInterface inputStreamProvider)
            throws IOException {
        return metsXmlElementAccess.read(inputStream, inputStreamProvider);
    }
