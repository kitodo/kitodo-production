...
public class LegacyLogicalDocStructHelper implements LegacyDocStructHelperInterface, BindingSaveInterface {
    ...
    LegacyLogicalDocStructHelper(StructuralElement child, LegacyLogicalDocStructHelper parent,
            RulesetManagementInterface ruleset, List<LanguageRange> priorityList) {
        this.structuralElement = child;
    ...
    public void addChild(LegacyDocStructHelperInterface child) {
        ...
        if (structuralElement instanceof IncludedStructuralElement) {
            ((IncludedStructuralElement) structuralElement).getChildren().add(legacyLogicalDocStructHelperChild.structuralElement);
        } else {
    ...
    public void addChild(Integer index, LegacyDocStructHelperInterface child) {
        ...
        legacyLogicalDocStructHelperChild.parent = this;
        if (structuralElement instanceof IncludedStructuralElement) {
            ((IncludedStructuralElement) structuralElement).getChildren().add(index, legacyLogicalDocStructHelperChild.structuralElement);
        } else {
            throw new IllegalStateException("cannot add child to linked structure");
        }
    }
    ...
    public void addMetadata(LegacyMetadataHelper metadata) {
        ...
        Map<Metadata, String> metadataEntriesMappedToKeyNames = ((IncludedStructuralElement) structuralElement).getMetadata().parallelStream()
    ...
    public boolean isLink() {
        return structuralElement.isLinked();
    }
    ...
    public void removeChild(LegacyDocStructHelperInterface docStruct) {
        ...
        ((IncludedStructuralElement) structuralElement).getChildren().remove(legacyLogicalDocStructHelperChild.structuralElement);
    }
