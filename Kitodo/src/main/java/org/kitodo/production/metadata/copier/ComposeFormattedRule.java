...
public class ComposeFormattedRule extends DataCopyrule {
     ...
     * @see org.kitodo.production.metadata.copier.DataCopyrule#apply(org.kitodo.production.metadata.copier.CopierData)
     */
    @Override
     ...
     * @see org.kitodo.production.metadata.copier.DataCopyrule#getMaxObjects()
     */
    @Override
     ...
     *
     * @return always 2
     * @see org.kitodo.production.metadata.copier.DataCopyrule#getMinObjects()
     */
    @Override
     ...
     *
     * @see org.kitodo.production.metadata.copier.DataCopyrule#setObjects(java.util.List)
     */
    @Override
     ...
     *
     * @see org.kitodo.production.metadata.copier.DataCopyrule#setSubject(java.lang.String)
     */
    @Override
