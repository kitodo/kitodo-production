...
import de.sub.kitodo.statistik.StatistikLaufzeitSchritte;
import de.sub.kitodo.statistik.StatistikStatus;
...
import org.kitodo.production.flow.statistics.enums.ResultOutput;
...
public class StatisticsManager implements Serializable {
    ...
    public void calculate() {
         ...
         * and save it as List of DataTables (because some statistical questions
