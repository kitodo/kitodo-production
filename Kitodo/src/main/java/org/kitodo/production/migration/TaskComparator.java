...
public class TaskComparator implements Comparator<Task> {
    ...
    public int compare(Task firstTask, Task secondTask) {
        ...
        if (Objects.isNull(firstTask.getTitle()) ? !Objects.isNull(secondTask.getTitle())
                : !firstTask.getTitle().equals(secondTask.getTitle())) {
            return 1;
        }
        if (Objects.isNull(firstTask.getOrdering()) ? !Objects.isNull(secondTask.getOrdering())
        ...
        if (Objects.isNull(firstTask.getScriptPath()) ? !Objects.isNull(secondTask.getScriptPath())
