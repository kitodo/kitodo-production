...
ALTER TABLE process
  ...
  CHANGE IstTemplate template TINYINT(1),
  CHANGE inAuswahllisteAnzeigen inChoiceListShown TINYINT(1),
...
ALTER TABLE processProperty
  ...
  CHANGE IstObligatorisch obligatory TINYINT(1),
...
ALTER TABLE user
  ...
  CHANGE IstAktiv active TINYINT(1),
