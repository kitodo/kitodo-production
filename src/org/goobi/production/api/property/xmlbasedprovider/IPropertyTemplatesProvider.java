...
public interface IPropertyTemplatesProvider {
	...
	/**
	 * 
	 * @param status {@link Status} of {@link IGoobiEntity}
	 * @param inEntity {@link IGoobiEntity} owning entity for properties
	 * @return list of {@link PropertyTemplate}s
	 */
	public abstract List<PropertyTemplate> getTemplates(Status status, IGoobiEntity inEntity);
}
