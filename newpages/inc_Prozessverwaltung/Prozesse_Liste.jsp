...
<htm:h4>
	...
	<h:outputText value="#{msgs.aktuelleProzesse}"
		rendered="#{ProzessverwaltungForm.modusAnzeige=='aktuell'}" />
			...
			<%-- Neu-Schaltknopf --%>
			<h:commandLink action="#{ProzessverwaltungForm.Neu}" immediate="true" rendered="#{(LoginForm.maximaleBerechtigung == 1) || (LoginForm.maximaleBerechtigung == 2)}" id="new">
...
<x:dataTable id="auflistung" styleClass="standardTable" width="100%"
	...
	var="item" value="#{ProzessverwaltungForm.page.listReload}">
	...
	<x:column rendered="true" id="ajaxcolumn" style="text-align:left">
		...
		<h:panelGroup id="auflistungIntern">
			<x:dataTable id="prozessdetails" styleClass="standardTable"
			...
			<x:div>
				...
				<h:commandLink action="#{ProzessverwaltungForm.FilterAlleStart}" id="sort10"
					...
					<h:graphicImage value="/newpages/images/sorting/asc.gif"
						style="vertical-align:middle;margin-left:5px" />
					<x:updateActionListener
						property="#{ProzessverwaltungForm.sortierung}" value="projektDesc" />
				</h:commandLink>
				<%-- Sortierung Desc --%>
	...
	<x:column style="text-align:center" width="223px" styleClass="action">
		...
		<h:commandLink action="ProzessverwaltungBearbeiten" id="action10"
			...
			<x:updateActionListener property="#{ProzessverwaltungForm.myProzess}"
				value="#{item}" />
			<x:updateActionListener
		...
		<h:panelGroup
			...
			<h:commandLink action="#{ProzessverwaltungForm.ExportPdf}" id="action20"
			...
			<h:commandLink action="#{ProzessverwaltungForm.ExportDMS}" id="action21"
