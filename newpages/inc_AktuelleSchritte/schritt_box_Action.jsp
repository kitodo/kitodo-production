				...
				<htm:td styleClass="eingabeBoxen_row2">
					<h:panelGrid columns="1">
						...
						<h:commandLink id="action3"
							rendered="#{AktuelleSchritteForm.mySchritt.typScriptStep && AktuelleSchritteForm.mySchritt.typAutomatischScriptpfad != ''  && AktuelleSchritteForm.mySchritt.prozess.benutzerGesperrt == null}"
						...
						<h:commandLink id="action4"
							rendered="#{AktuelleSchritteForm.mySchritt.typScriptStep && AktuelleSchritteForm.mySchritt.typAutomatischScriptpfad2 != '' && AktuelleSchritteForm.mySchritt.prozess.benutzerGesperrt == null}"
							action="#{AktuelleSchritteForm.executeScript}"
						...
						<h:commandLink id="action5"
							rendered="#{AktuelleSchritteForm.mySchritt.typScriptStep && AktuelleSchritteForm.mySchritt.typAutomatischScriptpfad3 != '' && AktuelleSchritteForm.mySchritt.prozess.benutzerGesperrt == null}"
							action="#{AktuelleSchritteForm.executeScript}"
						...
						<h:commandLink id="action6"
							rendered="#{AktuelleSchritteForm.mySchritt.typScriptStep && AktuelleSchritteForm.mySchritt.typAutomatischScriptpfad4 != '' && AktuelleSchritteForm.mySchritt.prozess.benutzerGesperrt == null}"
							action="#{AktuelleSchritteForm.executeScript}"
						...
						<h:commandLink id="action7"
							rendered="#{AktuelleSchritteForm.mySchritt.typScriptStep && AktuelleSchritteForm.mySchritt.typAutomatischScriptpfad5 != '' && AktuelleSchritteForm.mySchritt.prozess.benutzerGesperrt == null}"
							action="#{AktuelleSchritteForm.executeScript}"
