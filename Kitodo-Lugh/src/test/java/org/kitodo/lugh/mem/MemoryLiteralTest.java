...
public class MemoryLiteralTest {
    ...
    public void testHashCodeIsDifferentForDifferentContent() {
        MemoryLiteral one = new MemoryLiteral("<mods:role><mods:roleTerm authority=\"marcrelator\" type=\"code\">aut</mods:roleTerm></mods:role>", RDF.XML_LITERAL);
        MemoryLiteral other = new MemoryLiteral("<mods:role><mods:roleTerm authority=\"marcrelator\" type=\"code\">edt</mods:roleTerm></mods:role>", RDF.XML_LITERAL);
    ...
    public void testCreateCreatesMemoryNodeReference1() {
        assertEquals(new MemoryNodeReference("http://www.kitodo.org/"), MemoryLiteral.create("http://www.kitodo.org/", null));
    }

    @Test
    public void testCreateCreatesMemoryNodeReference2() {
        assertEquals(new MemoryNodeReference("http://www.kitodo.org/"), MemoryLiteral.create("http://www.kitodo.org/", ""));
    }

    @Test
    public void testCreateCreatesPlainMemoryLiteral1() {
        assertEquals(
            new MemoryLiteral("public static void main(String[] args)", RDF.PLAIN_LITERAL),
    ...
    public void testCreateCreatesLangString() {
        assertEquals(
            new MemoryLangString("Hoc est corpus meum.", "la"),
    ...
    public void testCreateMemoryLiteralCreatesPlainMemoryLiteral1() {
        assertEquals(
            new MemoryLiteral("http://www.kitodo.org/", RDF.PLAIN_LITERAL),
    ...
    public void testMemoryLiteralCanBeCreatedAsRDF_HTML() {
        assertNotNull(
            new MemoryLiteral("<html><body><h1>It works!</h1></body></html>", "http://www.w3.org/1999/02/22-rdf-syntax-ns#HTML")
        );
    }
    ...
    public void testMemoryLiteralCanBeCreatedAsRDF_XMLMemoryLiteral() {
        assertNotNull(new MemoryLiteral("<mods:role><mods:roleTerm authority=\"marcrelator\" type=\"code\">aut</mods:roleTerm></mods:role>", RDF.XML_LITERAL));
    }
    ...
    public void testGetType() {
        assertEquals(RDF.PLAIN_LITERAL.getIdentifier(), new MemoryLiteral("Lorem ipsum dolor sit amet", RDF.PLAIN_LITERAL).getType());
    }

    @Test
    public void testGetValue() {
        assertEquals("Lorem ipsum dolor sit amet", new MemoryLiteral("Lorem ipsum dolor sit amet", RDF.PLAIN_LITERAL).getValue());
    }
    ...
    public void testToStringForTypedMemoryLiteral() {
        assertEquals(
            ...
            new MemoryLiteral("<html><body><h1>It works!</h1></body></html>", "http://www.w3.org/1999/02/22-rdf-syntax-ns#HTML").toString()
        );
    }
