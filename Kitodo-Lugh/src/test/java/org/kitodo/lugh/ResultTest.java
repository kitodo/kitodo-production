...
public class ResultTest {
    ...
    public void testForEachNodeReferenceWithTwoNodeReferencesAndALiteral() {
        for (Storage storage : TestConfig.STORAGES_TO_TEST_AGAINST) {
            Result r = createResult(storage, storage.createNodeReference("http://test.example/alice"),
                    storage.createNodeReference("http://test.example/bob"),
                    storage.createLiteral("42", RDF.PLAIN_LITERAL));
            KeySetView<String, Boolean> results = ConcurrentHashMap.<String>newKeySet();
    ...
    /**
     * Tests {@code namedNodeOrElseGet(Supplier<NamedNode>)} with one NamedNode
     * and a LangString.
     */
    @Test
    ...
    /**
     * Tests {@code namedNodeOrElseGet(Supplier<NamedNode>)} with an empty
     * result.
     */
    @Test
    ...
    /** Tests {@code namedNodeOrElseGet(Supplier<NamedNode>)} with a Node. */
    @Test
    ...
    /**
     * Tests {@code namedNodeOrElseGet(Supplier<NamedNode>)} with two
     * NamedNodes.
     */
    @Test
    ...
    /**
     * Tests {@code namedNodeOrElseGet(Supplier<NamedNode>)} with two NamedNodes
     * and a Leaf.
     */
    @Test
