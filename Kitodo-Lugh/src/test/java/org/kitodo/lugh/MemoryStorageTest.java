...
public class MemoryStorageTest {
    ...
    public void testCreateLangString() {
        assertThat(
                MemoryStorage.INSTANCE.createLangString(
                        "Die Zukunft wird nicht gemeistert von denen, die am Vergangenen kleben.", "de"),
                is(equalTo(new MemoryLangString(
                        "Die Zukunft wird nicht gemeistert von denen, die am Vergangenen kleben.", "de"))));
    ...
    public void testCreateLiteralStringString() {
        assertThat(
                ...
                is(equalTo(new MemoryLiteral("\\.ba\\, |delete operation|, 0xc0000034",
                        RDF.PLAIN_LITERAL.getIdentifier()))));
    }
    ...
    public void testCreateNodeNodeReference() {
        assertThat(MemoryStorage.INSTANCE.createNode(Mets.METS), is(equalTo(new MemoryNode(Mets.METS))));
    }
